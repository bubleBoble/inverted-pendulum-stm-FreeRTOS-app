...
// These values are used as task notification value for worker task
...
// These values are used as task notification value for test task
...
// Worker task - this tas is only active when command "zero" or "home" are
...
// Controller 3 task
// Full state feedback Full state feedback with deadzone compensation, pendulum
// down position
