...
#define COMONOFF_HELPSTR \
    "<enter_key> : Start / stop data streaming\r\n"

#define COMONOFFQ_HELPSTR \
    "q           : Start / stop data streaming\r\n"
...
#define SWINGUP_HELPSTR \
    "swingup     : Start pendulum swing-up routine\r\n"

#define SWU_HELPSTR \
    "swu         : Alias for swingup command\r\n"

#define SWINGDOWN_HELPSTR \
    "swingdown   : Start pendulum swing-down routine\r\n"

#define SWD_HELPSTR \
    "swd         : Alias for swingdown command\r\n"

#define RESET_HELPSTR \
    "reset       : Resets microcontroller\r\n"

#define RR_HELPSTR \
    "rr          : Alias for \"reset\" command\r\n"

#define VOL_HELPSTR \
    "vol         : Manually set DC motor voltage\r\n"

#define V_HELPSTR \
    "v           : Alias for \"vol\" command\r\n"
...
#define BO_HELPSTR \
    "bo          : Toggle cart min/max bounce-off protection\r\n"

#define TEST_HELPSTR \
    "test        : Start a test procedure\r\n"

#define TCC_HELPSTR \
    "tcc         : Start a test procedure\r\n"

#define TCP_HELPSTR \
    "tcp         : Start a test procedure\r\n"
