...
void ctrl_3_FSF_downpos_task(void *pvParameters)
{
        ...
        float switch_angle_low =
                (180 - 80) * PI / 180.0f; // lower boundry in rad
        float switch_angle_high =
                (180 + 80) * PI / 180.0f; // upper boundry in rad
        ...
        for (;;) {
                ...
                if (is_pend_angle_ok) {
                        ...
                        pend_position_error =
                                pend_arm_ang_setp_rad_dpc - pend_angle[0];
                        ...
                        if (cart_position_error >
                            cart_position_allowed_error_cm) {
                                // ctrl_cart_position_error =
                                //     tanhf( 8.0f * cart_position_error ) *
                                //     ( gains[0] * cart_position_error + voltage_deadzone );
                                ctrl_cart_position_error =
                                        gains[0] * cart_position_error +
                                        voltage_deadzone;
                        } else if (cart_position_error <
                                   -cart_position_allowed_error_cm) {
                                // ctrl_cart_position_error =
                                //     - tanhf( 8.0f * cart_position_error ) *
                                //     ( gains[0] * cart_position_error - voltage_deadzone );
                        ...
                        // }
                        // if( ( cart_pos[0] < 5.0f ) ||
                        //     ( cart_pos[0] > (TRACK_LEN_MAX_CM-5.0f) ) )
