...
/* This flag indicates that bounceoff task was resumed and is running */
...
/* global variables to hold four control signal components from active 
controller task. COM_SEND_CTRL_DEBUG is defined in main_LIP.c */
