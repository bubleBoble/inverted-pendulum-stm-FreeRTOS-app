                                  ...
                                  const int8_t *pcCommandString)
{
        ...
        if (app_current_state == UNINITIALIZED) {
                ...
                if (READ_ZERO_POSITION_REACHED) {
                        ...
                        // to track center
                        xTaskNotifyIndexed(cartworker_TaskHandle, 0,
                                           GO_LEFT + GO_RIGHT,
                                           eSetValueWithOverwrite);
                }
                ...
                if (app_current_state == DPC || app_current_state == UPC) {
                        ...
                        if (cart_position_setpoint_cm ==
                            &cart_position_setpoint_cm_cli) {
                                ...
                                new_setpoint = strtof(
                                        (const char *)pcParameter1, &errCheck);
        ...
        if (app_current_state == UNINITIALIZED ||
            app_current_state == DEFAULT) {
                ...
                if ((int8_t *)errCheck == pcParameter1) {
                        ...
                        strcpy((char *)pcWriteBuffer, (const char *)msg);
                } else {
                        sprintf((char *)pcWriteBuffer,
                                "\r\nVoltage set to: %f\r\n",
