...
static portBASE_TYPE prvqCommand( int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString );
...
static const CLI_Command_Definition_t prvqCommandDefinition =
{
...
void vRegisterCLICommands()
{
    ...
    FreeRTOS_CLIRegisterCommand( &prvqCommandDefinition );
}
