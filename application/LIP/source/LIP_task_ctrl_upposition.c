...
void ctrl_5_FSF_uppos_task(void *pvParameters)
{
        ...
        /* 
         * Gains from first test iteration. There is about 2cm error in cart
         * position 
         */
        // float gains[4] = { -70.710678, -76.351277, -50.892920, -9.096002 };
        // float gains[4] = { -113.3893f, -182.8326f, -93.5820f, -20.7248f };
        ...
        /* 
         * Allowed error for cart position in centimeters (cm). There will 
         * always be some steady state error becouse of the presence of voltage 
         * deadzone in real pendulum
         */
